...
<html>
	...
	<div id="content" class="snap-content">
		<header class="bar-title">
			...
			<h1 class="title logo">Sulit.com.ph</h1>
			<button class="button sell-button" id="toggle-right"><i class="icon-pushpin icon-rotate-60"></i> Sell</button>
		</header>
	
		<!-- Wrap all non-bar HTML in the .content div (this is actually what scrolls) -->
		<div class="content">
		<a class="button-block"><i class="icon-map-marker"></i> Find my Location</a>
			
		<ul class="list">
			<li class="list-divider">Search in: </li>
			<li>
				<a href="login.php" data-transition="slide-in">Mega Manila <span class="chevron"></span></a>
			</li>
			<li>
				<a href="">Northern Luzon <span class="chevron"></span></a>
			</li>
			<li>
				<a href="">Southern Luzon <span class="chevron"></span></a>
			</li>
			<li>
				<a href="">Cebu <span class="chevron"></span></a>
			</li>
			<li>
				<a href="">Davao <span class="chevron"></span></a>
			</li>
		</ul>
